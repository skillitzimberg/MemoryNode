...
The project files generated will have starter content as outlined in the Epicodus JavaScript course. The template will give relevant namespaces and paths for your project (i.e. memory will be replaced everywhere with the name you give to your project - YourProjectName).
...
Clone the code from [GitHub](https://github.com/skillitzimberg/memory).
...
* dotnet new --install [ /Users/Your/Path/Here ]/memory

For example: When cloned to the Epicodus computer Desktop, the path would be /Users/Guest/Desktop/memory.  

The above command would then be:
* dotnet new --install /Users/Guest/Desktop/memory
